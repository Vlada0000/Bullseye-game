window.addEventListener('load', function () {
    ...
    class Player {
        constructor(game) {
            this.game = game;
            this.collisionX = this.game.width * 0.8
            this.collisionY = this.game.height * 0.9
    ...
    class Game {
        ...
        render(context, deltaTime) {
            ...
            if (this.score >= this.winningScore) {
                ...
                context.fillText("Final Score: " + this.score + '. Click R to restart', this.width * 0.5, this.height * 0.5 + 80)
                context.restore()
            }
        ...
        init() {
            ...
            while (this.obstacles.length < this.numberOfObstacles && attempts < 500) {
                ...
                if (!overlapping && testObstacle.spriteX > 0 && testObstacle.spriteX < this.width - testObstacle.width && testObstacle.collisionY > this.topMargin + margin && testObstacle.collisionY < this.height - margin) {
    ...
    function animate(timeStamp) {
      ...
      /*if (!game.gameOver)*/ requestAnimationFrame(animate); // 1 request
